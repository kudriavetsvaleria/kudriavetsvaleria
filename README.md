<!-- README.md (repo must be named exactly kudriavetsvaleria) -->
...
<p align="center">
  <picture>
    <!-- Синяя тема -->
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/kudriavetsvaleria/kudriavetsvaleria/output/snake-blue.svg" />
    <!-- Светлая тема -->
